...
def main():
    ...
    train_set = SpiralDataset(cfg.train_ds.n_dataset, cfg.n_sample, save_data=False, data_path=None)
    valid_set = SpiralDataset(cfg.valid_ds.n_dataset, cfg.n_sample, save_data=True, data_path="valid")
